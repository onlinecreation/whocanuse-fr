...
export class PercentBars extends Component {
  ...
  render() {
    ...
    return (
      <CompleteWrapper>
        <TextWrapper>
          <SmallText style={{ color: theme.color.green }}>{positivePercent}% peut</SmallText>
          <SmallText style={{ color: theme.color.red }}>{negativePercent}% auront des difficultés</SmallText>
        </TextWrapper>
        <BarWrapper>
